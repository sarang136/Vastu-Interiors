        ...
        <div className='secondKitchenContainer'>
            ...
            <div className='heroFirstImage'>
                <div className='imageDiv'>
                    <img src={DiningImagesData[11].image} alt="Design" />
                </div>
                <div className='textDiv'>
                    ...
                    <div>
                        ...
                        }}> <span style={{ fontWeight: "600", color: "" }}>Style : </span> {DiningImagesData[11].style}</p>
                        <p style={{
                            fontSize: "18px",

                            // fontWeight:"600"

                        }}> <span style={{ fontWeight: "600" }}>Room Dimensions : </span>{DiningImagesData[11].rdimensions}</p>
                        <p style={{
                            fontSize: "18px",
                            // fontWeight:"600"

                        }}> <span style={{ fontWeight: "600" }}>Furniture Highlights: </span>{DiningImagesData[11].fhighlights}</p>

                        <p style={{
                            fontSize: "18px",

                        }}> <span style={{ fontWeight: "600" }}>Room Highlights: </span>{DiningImagesData[11].rhighlights}</p>
            ...
            <div className='SecondKitgoNextbtn '>
                <Link to="/eleventhdinimage"> <button className='arrow left'></button></Link>
            </div>
...
export default TwelvethDinImage;