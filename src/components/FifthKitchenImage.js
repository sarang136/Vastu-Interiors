                ...
                <div className='textDiv'>
                    ...
                    <div>
                        ...
                        <p style={{
                            ...
                            fontWeight: "600",
                            width: "420px"
                        }}>{FirstKitchenImageData[4].name}</p>
                        <p
                            style={{
                                fontSize: "18px",
                                fontWeight: "600",
                            ...
                            }}> {FirstKitchenImageData[4].details}</p>
                        <p style={{
                            fontSize: "18px",
                            // fontWeight:"600"
                            marginTop: "20px"

                        }}> <span style={{ fontWeight: "600", color: "" }}>Layout : </span> {FirstKitchenImageData[4].layout}</p>
                        <p style={{
                            fontSize: "18px",

                            // fontWeight:"600"

                        }}> <span style={{ fontWeight: "600" }}>Room Dimensions : </span>{FirstKitchenImageData[4].roomD}</p>
                        <p style={{
                            fontSize: "18px",
                            // fontWeight:"600"

                        }}> <span style={{ fontWeight: "600" }}>Style : </span>{FirstKitchenImageData[4].style}</p>
                        <p style={{
                            fontSize: "18px",
                            // fontWeight:"600"

                        }}> <span style={{ fontWeight: "600" }}>Color : </span>{FirstKitchenImageData[4].color}</p>
                        <p style={{
                            fontSize: "18px",
